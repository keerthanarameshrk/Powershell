#CreateListWithColumnValue -configfile "E:\\Powershell schema\\Office_365_Sharepoint.Properties" -LogPath "E:\\Powershell schema\\Log\\log.log" 
...
Logger -LogPath $LogPath -LogContent "Started ^ CreateSiteCollection @ Script"
    ...
    #Logger -LogPath $LogPath -LogContent "$password.Trim()"
