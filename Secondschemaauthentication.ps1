...
#$siteURL = "https://maargasystems007.sharepoint.com/sites/DensoDevPPM"
  try{  
[Net.ServicePointManager]::SecurityProtocol = [Net.ServicePointManager]::SecurityProtocol -bor [Net.SecurityProtocolType]::Tls12	
    ...
    Write-Host "$($Properties.listcsvpath.Trim())"
    Logger -LogPath $LogPath -LogContent "$($Properties.listcsvpath.Trim())"
...
$context.ExecuteQuery()
 ...
 #>
					...
					$alterField=$key.AlterField
					$Type=$key.Type
                    
                    if($alterField -ne $null -and $alterField -ne "")
                    {
                        
                        $columnName=$alterField
                    }
...
Write-Host "Modified column name is :: $($ColumnName)"
	...
	$ListOfCol = $context.Web.Lists
	$context.Load($ListOfCol)	
 $context.executeQuery()		
foreach($li in $ListOfCol)
{
#Write-Host "List title::$($listTitle)"
#Write-Host "List title::$($li.Title)"
if($li.Title -eq $listTitle)
...
$list = $context.Web.Lists.GetByTitle($listTitle)
 ...
 Logger -LogPath $LogPath -LogContent "List Created :  $listTitle"
    ...
    $Field = $Fields | where{$_.InternalName -eq $columnName}
    ...
    elseif($columnType -eq "1024"){
    
    $fieldXML="<Field Type='DateTime' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
    elseif($columnType -eq "1"){
    ...
    elseif($columnType -eq "768"){
    
    $fieldXML="<Field Type='Number' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
    <#elseif($columnType -eq "MultiChoice"){
    $fieldXML="<Field Type='MultiChoice' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' FillInChoice='TRUE' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
	...
	elseif($Type -eq "MultiLine"){
    $fieldXML="<Field Type='Note' DisplayName='"+$columnDisplayName+"'  Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
     else{
    
    $fieldXML="<Field Type='Text' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
