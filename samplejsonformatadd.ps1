...
#$siteURL="https://maargasystems007.sharepoint.com/sites/MF2020upgrade"
#$siteURL="https://maargasystems007.sharepoint.com/sites/LNTOSPOPOC"
#$siteURL="https://maargasystems007.sharepoint.com/sites/Tranineesitebatch2021/maheplaysite"
#$siteURL="https://maargasystems007.sharepoint.com/sites/sunlifepilot_prod/MF2020upgrade_DataMig/DataMigration"
$siteURL="https://maargasystems007.sharepoint.com/sites/site_1"
#$siteURL="https://slftest.sharepoint.com/sites/LNDB2/MFSUDataPOC"
   #$siteURL="https://slftest.sharepoint.com/sites/LNDB2/MFSU"
   #$siteURL="https://maargasystems007.sharepoint.com/sites/sunlifepilot_dev/MF2020upgrade"
    #$siteURL="https://maargasystems007.sharepoint.com/sites/sunlifepilot_prod/MF2020upgrade"
    #$siteURL="https://maargasystems007.sharepoint.com/sites/sunlifepilot_prod/MF2020upgrade_DataMig"
   #$siteURL = "https://maargasystems007.sharepoint.com/sites/Tranineesite"
	#$siteURL = "https://lindegroup.sharepoint.com/sites/LGREE-ATDIGIGAS-TEST"
	#$siteURL = "https://team.effem.com/sites/capadev"
...
Write-Host "Modified column name is :: $($ColumnName)"
    ...
    $fieldXML="<Field Type='"+$columnType+"' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'><CHOICES>$choices</CHOICES>$default</Field>"
    }
    elseif($columnType -eq "DateTime"){
    
    $fieldXML="<Field Type='"+$columnType+"' DisplayName='"+$columnDisplayName+"' Name='"+$columnName+"' Format='"+$format+"' Required='"+$Required+"' ShowInNewForm='"+$showInNewForm+"' ShowInDisplayForm='"+$showInDisplayForm+"' ShowInEditForm='"+$showInEditForm+"' ReadOnly='"+$readOnly+"'>$default</Field>"
    }
...
$list.CustomFromJson($JsonFormat)
$list.Update()
